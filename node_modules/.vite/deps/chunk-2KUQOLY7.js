import {
  init_depth_fragment
} from "./chunk-IDEL4R3Y.js";
import {
  init_depth_vertex
} from "./chunk-INXSHOXN.js";
import {
  Light,
  init_light
      ...
      async _initShaderSourceAsync(forceGLSL = false) {
        ...
        if (engine.isWebGPU && !forceGLSL && !_ShadowGenerator.ForceGLSL) {
          ...
          await Promise.all([
            ...
            import("./shadowMap.vertex-J2VL5CV3.js"),
            import("./depthBoxBlur.fragment-KWNXJ6U7.js"),
            import("./shadowMapFragmentSoftTransparentShadow-7T6MKQRE.js")
          ]);
        } else {
          await Promise.all([
            import("./shadowMap.fragment-KKTTZZRY.js"),
            import("./shadowMap.vertex-FDPPIXGP.js"),
    ...
    DepthRenderer = class _DepthRenderer {
      ...
      async _initShaderSourceAsync(forceGLSL = false) {
        ...
        if (engine.isWebGPU && !forceGLSL && !_DepthRenderer.ForceGLSL) {
          this._shaderLanguage = 1;
          await Promise.all([import("./depth.vertex-UYW32ZHZ.js"), import("./depth.fragment-UDEZJNYC.js")]);
        } else {
          await Promise.all([import("./depth.vertex-L4GYYEPY.js"), import("./depth.fragment-CHNQWKZ7.js")]);
        }
        this._shadersLoaded = true;
      }
      /**
...
//# sourceMappingURL=chunk-2KUQOLY7.js.map
