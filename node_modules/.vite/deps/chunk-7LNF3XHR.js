          ...
          this._drawWrapper.effect = engine.createEffect(shaders, [VertexBuffer.PositionKind], this._uniforms, this._samplers, defines, void 0, void 0, () => {
            ...
            if (this._options.extraInitializationsAsync) {
              if (this.shaderLanguage === 1) {
                await Promise.all([import("./procedural.vertex-TBIM2EZ4.js"), this._options.extraInitializationsAsync()]);
              } else {
                await Promise.all([import("./procedural.vertex-Y2YTKCL3.js"), this._options.extraInitializationsAsync()]);
              }
            } else {
              if (this.shaderLanguage === 1) {
                await import("./procedural.vertex-TBIM2EZ4.js");
              } else {
                await import("./procedural.vertex-Y2YTKCL3.js");
              }
            }
          });
        }
...
//# sourceMappingURL=chunk-7LNF3XHR.js.map
