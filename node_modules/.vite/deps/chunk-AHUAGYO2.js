...
} from "./chunk-EDBMKN7X.js";
import {
  Scene,
  init_scene
} from "./chunk-47H4IP7R.js";
import {
  Light,
  init_light
...
function blockFactory(blockName) {
  switch (blockName) {
    case "FlowGraphPlayAnimationBlock":
      return async () => (await import("./flowGraphPlayAnimationBlock-NWBJAME4.js")).FlowGraphPlayAnimationBlock;
    ...
    case "FlowGraphReceiveCustomEventBlock":
      return async () => (await import("./flowGraphReceiveCustomEventBlock-AGQUPKYR.js")).FlowGraphReceiveCustomEventBlock;
        ...
        const effect = engine.createEffect(shaderName, {
          ...
          extraInitializationsAsync: this._shadersLoaded ? void 0 : async () => {
            if (this.shaderLanguage === 1) {
              await Promise.all([import("./pbr.vertex-7BOYRF5V.js"), import("./pbr.fragment-VICHXYON.js")]);
            } else {
              await Promise.all([import("./pbr.vertex-CIYSQCD7.js"), import("./pbr.fragment-I4Q7PP6G.js")]);
            }
...
//# sourceMappingURL=chunk-AHUAGYO2.js.map
