    ...
    ShadowGenerator = class _ShadowGenerator {
      ...
      async _initShaderSourceAsync(forceGLSL = false) {
        ...
        if (engine.isWebGPU && !forceGLSL && !_ShadowGenerator.ForceGLSL) {
          ...
          await Promise.all([
            import("./shadowMap.fragment-J5Z2J7Q7.js"),
            import("./shadowMap.vertex-3OJJDJW6.js"),
          ...
          await Promise.all([
            ...
            import("./shadowMap.vertex-7H6GQYJR.js"),
    ...
    DepthRenderer = class _DepthRenderer {
      ...
      async _initShaderSourceAsync(forceGLSL = false) {
        ...
        if (engine.isWebGPU && !forceGLSL && !_DepthRenderer.ForceGLSL) {
          this._shaderLanguage = 1;
          await Promise.all([import("./depth.vertex-TEZKFJYI.js"), import("./depth.fragment-KE2YSGKM.js")]);
        } else {
          await Promise.all([import("./depth.vertex-IZDMCRJD.js"), import("./depth.fragment-CHNQWKZ7.js")]);
        }
        this._shadersLoaded = true;
      }
      /**
...
//# sourceMappingURL=chunk-DXUPYUQG.js.map
