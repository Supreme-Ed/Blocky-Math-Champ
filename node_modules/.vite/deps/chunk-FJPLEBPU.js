...
async function _CreateDumpRenderer() {
  if (!_enginePromise) {
    _enginePromise = new Promise((resolve, reject) => {
      ...
      import("./thinEngine-FRYKA565.js").then(({ ThinEngine: thinEngineClass }) => {
        var _a;
        ...
        import("./pass.fragment-S4CM3NYF.js").then(({ passPixelShader }) => {
          if (!engine) {
...
//# sourceMappingURL=chunk-FJPLEBPU.js.map
