...
import {
  RGBDTextureTools,
  _UpdateRGBDAsync
} from "./chunk-ZUIYOZ4H.js";
import {
  ImageProcessingConfiguration,
  Scene,
  _ImportHelper
} from "./chunk-3D2GM5AB.js";
import {
  AutoReleaseWorkerPool
} from "./chunk-QDXIFF52.js";
import {
  ToHalfFloat
} from "./chunk-Z3X3IWFI.js";
import {
  AbstractMesh,
  Geometry,
  Mesh,
...
import {
  BaseTexture,
  Texture
} from "./chunk-OMYDZTJG.js";
import {
  BoundingInfo,
  IntersectionInfo,
  Material,
  SubMesh
} from "./chunk-SYJTRSY7.js";
import {
  BindBonesParameters,
  BindFogParameters,
  BindLights,
      ...
      let effect = scene.getEngine().createEffect(shaderName, {
        ...
        extraInitializationsAsync: this._shadersLoaded ? void 0 : async () => {
          if (this._shaderLanguage === 1) {
            await Promise.all([import("./default.vertex-4U2WH667.js"), import("./default.fragment-3NSGQ67N.js")]);
          } else {
            await Promise.all([import("./default.vertex-EVMTUVDT.js"), import("./default.fragment-DIIU6NSQ.js")]);
          }
...
function blockFactory(blockName) {
  switch (blockName) {
    case "FlowGraphPlayAnimationBlock":
      return async () => (await import("./flowGraphPlayAnimationBlock-ALYGZ36V.js")).FlowGraphPlayAnimationBlock;
    ...
    case "FlowGraphReceiveCustomEventBlock":
      return async () => (await import("./flowGraphReceiveCustomEventBlock-IAOUBVU4.js")).FlowGraphReceiveCustomEventBlock;
    case "FlowGraphMeshPickEventBlock":
      return async () => (await import("./flowGraphMeshPickEventBlock-MCJFHTNI.js")).FlowGraphMeshPickEventBlock;
    ...
    case "FlowGraphEasingBlock":
      return async () => (await import("./flowGraphEasingBlock-GHIIMT6K.js")).FlowGraphEasingBlock;
    case "FlowGraphBezierCurveEasing":
      return async () => (await import("./flowGraphBezierCurveEasingBlock-76MA4ILU.js")).FlowGraphBezierCurveEasingBlock;
    case "FlowGraphPointerOverEventBlock":
      return async () => (await import("./flowGraphPointerOverEventBlock-2KMAH77U.js")).FlowGraphPointerOverEventBlock;
    case "FlowGraphPointerOutEventBlock":
      return async () => (await import("./flowGraphPointerOutEventBlock-XGTVET2D.js")).FlowGraphPointerOutEventBlock;
    ...
    const effect = engine.createEffect(shaderName, {
      ...
      extraInitializationsAsync: this._shadersLoaded ? void 0 : async () => {
        if (this.shaderLanguage === 1) {
          await Promise.all([import("./pbr.vertex-UP2AZV7I.js"), import("./pbr.fragment-ZDQ2WZ4E.js")]);
        } else {
          await Promise.all([import("./pbr.vertex-IHZZXR7I.js"), import("./pbr.fragment-UBPJ6WSH.js")]);
        }
        this._shadersLoaded = true;
      }
    }, engine);
    ...
    if (defines.isDirty) {
      ...
      const effect = scene.getEngine().createEffect("gaussianSplatting", {
        ...
        extraInitializationsAsync: async () => {
          if (this._shaderLanguage === 1) {
            await Promise.all([import("./gaussianSplatting.fragment-73JLOGJQ.js"), import("./gaussianSplatting.vertex-IT66O2QL.js")]);
          } else {
...
//# sourceMappingURL=chunk-HC2KDWC4.js.map
