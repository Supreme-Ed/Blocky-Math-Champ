...
} from "./chunk-4HQUBE54.js";
import {
  EffectWrapper
} from "./chunk-HQ3ILV5N.js";
import {
  PerfCounter
...
var PostProcess = class _PostProcess {
  ...
  _gatherImports(useWebGPU = false, list) {
    if (useWebGPU && this._webGPUReady) {
      list.push(Promise.all([import("./postprocess.vertex-DFH7ITPX.js")]));
    } else {
      list.push(Promise.all([import("./postprocess.vertex-C56VSLQQ.js")]));
    }
  }
  /**
...
ThinEngine.prototype.createPrefilteredCubeTexture = function(rootUrl, scene, lodScale, lodOffset, onLoad = null, onError = null, format, forcedExtension = null, createPolynomials = true) {
  const callback = async (loadData) => {
    ...
    const { DDSTools } = await import("./dds-A6WY2L7W.js");
    const textures = [];
...
var ThinPassPostProcess = class _ThinPassPostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      ...
      list.push(Promise.all([import("./pass.fragment-CI646JSR.js")]));
    } else {
      list.push(Promise.all([import("./pass.fragment-S4CM3NYF.js")]));
    }
...
var ThinPassCubePostProcess = class _ThinPassCubePostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      this._webGPUReady = true;
      list.push(Promise.all([import("./passCube.fragment-PJ3HKMMW.js")]));
    } else {
      list.push(Promise.all([import("./passCube.fragment-UWSHXOEH.js")]));
    }
    super._gatherImports(useWebGPU, list);
  }
  /**
...
var ProcessAsync = async (texture, width, height, face, lod) => {
  ...
  if (!engine.isWebGPU) {
    if (texture.isCube) {
      await import("./lodCube.fragment-HCTMNYOH.js");
    } else {
      await import("./lod.fragment-EAD2XI54.js");
    }
  } else {
    if (texture.isCube) {
      await import("./lodCube.fragment-UQFCGSFS.js");
    } else {
      await import("./lod.fragment-RWXJPG3N.js");
    }
  }
  let lodPostProcess;
  if (!texture.isCube) {
...
//# sourceMappingURL=chunk-OT47EPUB.js.map
