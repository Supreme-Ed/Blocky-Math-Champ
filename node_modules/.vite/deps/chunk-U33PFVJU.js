...
} from "./chunk-YSAZQL6W.js";
import {
  RenderTargetTexture
} from "./chunk-JH2KO4YF.js";
import {
  SmartArray
} from "./chunk-AVENTWBY.js";
import {
  BaseTexture,
  Texture
...
ThinEngine.prototype.createPrefilteredCubeTexture = function(rootUrl, scene, lodScale, lodOffset, onLoad = null, onError = null, format, forcedExtension = null, createPolynomials = true) {
  const callback = async (loadData) => {
    ...
    const { DDSTools } = await import("./dds-CKP3AAKY.js");
    const textures = [];
...
//# sourceMappingURL=chunk-U33PFVJU.js.map
