    ...
    RGBDTextureTools = class {
      ...
      static ExpandRGBDTexture(texture) {
        ...
        const expandRGBDTexture = async () => {
          ...
          internalTexture.isReady = false;
          if (isWebGPU) {
            await import("./rgbdDecode.fragment-F6XKGV4E.js");
          } else {
            await import("./rgbdDecode.fragment-WAAZIQXP.js");
          }
      ...
      static async EncodeTextureToRGBD(internalTexture, scene, outputTextureType = 0) {
        if (!scene.getEngine().isWebGPU) {
          await import("./rgbdEncode.fragment-NHGSUEWO.js");
        } else {
          await import("./rgbdEncode.fragment-N3NQMEFW.js");
        }
...
//# sourceMappingURL=chunk-RGGEUBTP.js.map
