...
} from "./chunk-CNP3BXME.js";
import {
  Scene,
  init_scene
} from "./chunk-INKTANVP.js";
import {
  MaterialDefines,
  MaterialFlags,
  PushMaterial,
  ...
  init_materialFlags,
  init_pushMaterial
} from "./chunk-OQHS5OH3.js";
import {
  ImageProcessingConfiguration,
  init_imageProcessingConfiguration
} from "./chunk-5KDCVSNU.js";
import {
  Light,
  init_light
} from "./chunk-XSIMGGS5.js";
import {
  EffectFallbacks,
...
function blockFactory(blockName) {
  switch (blockName) {
    case "FlowGraphPlayAnimationBlock":
      return async () => (await import("./flowGraphPlayAnimationBlock-HHMRMJJ6.js")).FlowGraphPlayAnimationBlock;
    ...
    case "FlowGraphReceiveCustomEventBlock":
      return async () => (await import("./flowGraphReceiveCustomEventBlock-4ZPX3SRK.js")).FlowGraphReceiveCustomEventBlock;
    ...
    case "FlowGraphEasingBlock":
      return async () => (await import("./flowGraphEasingBlock-EEJCMO7G.js")).FlowGraphEasingBlock;
    case "FlowGraphBezierCurveEasing":
      return async () => (await import("./flowGraphBezierCurveEasingBlock-SO4UI26D.js")).FlowGraphBezierCurveEasingBlock;
        ...
        const effect = engine.createEffect(shaderName, {
          ...
          extraInitializationsAsync: this._shadersLoaded ? void 0 : async () => {
            if (this.shaderLanguage === 1) {
              await Promise.all([import("./pbr.vertex-FFH6RVVA.js"), import("./pbr.fragment-L5BM3XPN.js")]);
            } else {
              await Promise.all([import("./pbr.vertex-C2JQVVUX.js"), import("./pbr.fragment-X3GTYJ2S.js")]);
            }
...
//# sourceMappingURL=chunk-NRYVM26E.js.map
