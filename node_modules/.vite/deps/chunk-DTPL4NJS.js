      ...
      this._drawWrapper.effect = engine.createEffect(shaders, [VertexBuffer.PositionKind], this._uniforms, this._samplers, defines, void 0, void 0, () => {
        ...
        if (this._options.extraInitializationsAsync) {
          if (this.shaderLanguage === 1) {
            await Promise.all([import("./procedural.vertex-ALRBOOZI.js"), this._options.extraInitializationsAsync()]);
          } else {
            await Promise.all([import("./procedural.vertex-VVBCEJU7.js"), this._options.extraInitializationsAsync()]);
          }
        } else {
          if (this.shaderLanguage === 1) {
            await import("./procedural.vertex-ALRBOOZI.js");
          } else {
            await import("./procedural.vertex-VVBCEJU7.js");
          }
        }
      });
    }
...
//# sourceMappingURL=chunk-DTPL4NJS.js.map
