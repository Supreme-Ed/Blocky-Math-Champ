...
var RGBDTextureTools = class {
  ...
  static ExpandRGBDTexture(texture) {
    ...
    const expandRGBDTexture = async () => {
      ...
      internalTexture.isReady = false;
      if (isWebGPU) {
        await import("./rgbdDecode.fragment-5OPKQY73.js");
      } else {
        await import("./rgbdDecode.fragment-5SGHBEHB.js");
      }
  ...
  static async EncodeTextureToRGBD(internalTexture, scene, outputTextureType = 0) {
    if (!scene.getEngine().isWebGPU) {
      await import("./rgbdEncode.fragment-AJOORKQR.js");
    } else {
      await import("./rgbdEncode.fragment-KMELC6LT.js");
    }
...
//# sourceMappingURL=chunk-IZX4TIXI.js.map
