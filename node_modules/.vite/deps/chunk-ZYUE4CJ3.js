          ...
          const effect = scene.getEngine().createEffect("background", {
            ...
            extraInitializationsAsync: this._shadersLoaded ? void 0 : async () => {
              if (this.shaderLanguage === 1) {
                await Promise.all([import("./background.vertex-KU7LL2HY.js"), import("./background.fragment-HHKGN67D.js")]);
              } else {
                await Promise.all([import("./background.vertex-QUJVKD6Z.js"), import("./background.fragment-NG7PORZA.js")]);
              }
...
//# sourceMappingURL=chunk-ZYUE4CJ3.js.map
