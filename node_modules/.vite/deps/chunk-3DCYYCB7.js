...
async function _CreateDumpRenderer() {
  if (!_enginePromise) {
    _enginePromise = new Promise((resolve, reject) => {
      ...
      import("./thinEngine-FXZS23SE.js").then(({ ThinEngine: thinEngineClass }) => {
        var _a;
        ...
        import("./pass.fragment-4NZBZQQM.js").then(({ passPixelShader }) => {
          if (!engine) {
...
var _dumpToolsEngine, _enginePromise, DumpTools, initSideEffects;
...
//# sourceMappingURL=chunk-3DCYYCB7.js.map
